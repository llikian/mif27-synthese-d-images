...
private:
    ...
    Transform view_matrix;       ///< The camera's view matrix. Used every frame in the mvp matrix calculation.
    Transform projection_matrix; ///< The projection matrix. Used every frame in the mvp matrix calculation.

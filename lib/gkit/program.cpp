...
bool compile_program( const GLuint program, const std::string& name, const std::string& common_source, const std::string& definitions )
{
    assert(program);
...
bool reload_program( const GLuint program, const std::string& filename, const std::string& definitions )
{
    ...
    bool status= compile_program(program, filename, common_source, definitions);
...
GLuint create_program( const std::string& name, const std::string& source, const std::string& definitions )
{
    ...
    bool status= compile_program(program, name, source, definitions);
